...
import { formatDate } from 'pages/components/reservationDomain';
  ...
  return (
    ...
    >
      ...
      <ReservationTimeline
        ...
        onToggleReservation={id => setActiveReservation(activeReservation === id ? null : id)}
      />
      ...
      <MyReservationsSection myReservations={myReservationList} rooms={rooms} onCancel={handleCancel} />

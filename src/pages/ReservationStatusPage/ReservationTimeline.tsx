        ...
        >
          ...
          >
            {HOUR_LABELS.map(time => {
              const left = (timeToTimelineMinutes(time) / TOTAL_TIMELINE_MINUTES) * 100;
              return (
                <Text
                  key={time}
                  typography="t7"
            ...
            >
              ...
              >
                {roomReservations.map(reservation => {
                  const left = (timeToTimelineMinutes(reservation.start) / TOTAL_TIMELINE_MINUTES) * 100;
                  const width =
                    ((timeToTimelineMinutes(reservation.end) - timeToTimelineMinutes(reservation.start)) /
                      TOTAL_TIMELINE_MINUTES) *
                    100;
